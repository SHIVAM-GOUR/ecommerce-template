        ...
        <section className="bg-white p-4 rounded-lg shadow-md ">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-xl">
                    ...
                    <p className="text-black text-xl mt-4 border-t-2 border-gray-300 font-Nunito pt-2">Oxygen mask</p>
                ...
                <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-xl">
                    ...
                    <p className="text-black text-xl mt-5 border-t-2 border-gray-300 font-Nunito pt-2">Surgical gloves</p>
                    <p className="text-gray-500 font-bold mt-2">$19.99</p>
                    <button className="bg-orange-10 text-white px-4 py-2 rounded-md mt-4">
                        Add to Cart
                    </button>
                ...
                <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-xl">
                    ...
                    <p className="text-black text-xl mt-5 border-t-2 border-gray-300 font-Nunito pt-2">Medical mask</p>
                    <p className="text-gray-500 font-bold mt-2">$19.99</p>
                    <button className="bg-orange-10 text-white px-4 py-2 rounded-md mt-4">
                        Add to Cart
                    </button>
